...
// Define a test group
test.describe("Game Builder Tests", () => {
  ...
  // @ts-ignore - This function will be used in future tests
  ...
  test("should show/hide property panel based on selection", async ({
    page,
  }) => {
    await page.goto("http://localhost:5173/");
...
test.describe("Object Property Editor", () => {
  ...
  test("should update all object properties simultaneously", async ({
    page,
  }) => {
    await page.click(".game-canvas", { position: { x: 400, y: 300 } });
