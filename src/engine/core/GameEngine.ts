...
export class GameEngine {
    ...
    private updateViewMatrix(): void {
        ...
        const eye = [this.playerPosition.x, this.playerPosition.y, this.playerPosition.z];
        const center = [this.playerPosition.x + 1, this.playerPosition.y, this.playerPosition.z]; // Looking in +X direction
        const up = [0, 1, 0];
