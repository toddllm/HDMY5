...
# Script to run visual tests in headed mode (requires X11 forwarding)
...
# Run the visual tests in headed mode with slow motion
...
export PWDEBUG=1
npx playwright test tests/visual-test.spec.ts --project=chromium --headed --timeout=60000
